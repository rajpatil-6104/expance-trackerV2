  ...
  return (
    <div className={`flex flex-wrap items-center gap-2 sm:flex-nowrap ${className}`}>
      ...
      <div className="flex-1 min-w-[120px] sm:flex-none">
        <Select value={selectedMonth} onValueChange={setSelectedMonth}>
          <SelectTrigger className="w-full sm:w-[130px]" data-testid="csv-month-select">
            <SelectValue />
          </SelectTrigger>
          <SelectContent>
            {months.map((month) => (
      ...
      {/* Year Select */}
      <div className="flex-1 min-w-[90px] sm:flex-none">
        <Select value={selectedYear} onValueChange={setSelectedYear}>
          <SelectTrigger className="w-full sm:w-[100px]" data-testid="csv-year-select">
            <SelectValue />
          </SelectTrigger>
          <SelectContent>
            {years.map((year) => (
      ...
      <Button
        ...
        size={size}
        data-testid="download-csv-button"
        className="w-full sm:w-auto gap-2 order-last sm:order-none"
      >
        <Download className="h-4 w-4" />
